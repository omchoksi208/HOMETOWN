...
int main() {
    ...
    switch (c) {
    case '+': result = complex1.add(complex2); break;
    case '-': result = complex1.sub(complex2); break;
    case '/': result = complex1.div(complex2); break;
    case 'x': result = complex1.mul(complex2); break;
    case '!': result = complex1.neg();result1 = complex2.neg() ;  break;
    }
    result.display();
    result1.display();
